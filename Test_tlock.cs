  ...
  public static class Test_tlock
  {
    ...
    public static void RunTest_CheckFirma()
    {
      ...
      */
      ...
      var sigmaHexString = "82036f6bcd6f626ba4526edb9918a296877579707f49a494723d865d27d42d84dee9cce84a37c21fe6d365ad9fae75db";
      checkFirma(round, pkHexString, sigmaHexString);
    ...
    public static bool checkFirma(ulong round, G2 pk, G1 sigma)
    {
      ...
      //var hashRound_Fp = new Fp();      
      //var fp_bytesarray = new byte[48];
      //hashRound.Serialize().CopyTo(fp_bytesarray, 16);
      //hashRound_Fp.Deserialize(fp_bytesarray);      
      //hashRound_Fp.MapToG1(ref h, hashRound_Fp);
      //var h2 = new G1();
      //h2.HashAndMapTo(rbytes.Reverse().ToArray());
